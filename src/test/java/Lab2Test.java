...
public class Lab2Test {
    ...
    public void problem2SalaryGreaterThan(){
        //arrange
        Employee user1 = new Employee(3,"Steve", "Jones", 99890.99);
        ...
        try {
            ...
            Assert.fail("There was an issue running the SQL statement in lab2.");
        }
    ...
    public void beforeTest(){
        ...
        try {
            ...
            String sql2 = "INSERT INTO employee (first_name, last_name, salary) VALUES ('Steve', 'Garcia', 75000.00);";
